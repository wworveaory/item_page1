...
////////////////
const changPhoneItem = document.querySelectorAll('.changPhoneItem')
const vipgroup = document.getElementById('vip-group')

const inviteFriends=document.getElementById('invite-friends')

console.log(changPhoneItem.length)
changPhoneItem.addEventListener('click',function(){
  console.log('132')})
...
//       inviteFriends.display ='none'  
//     }
//     if (i == 1) {
//       console.log('1')
//       vipgroup.style.display = 'none'
//       inviteFriends.display ='block'
//     }
//   })
// }
